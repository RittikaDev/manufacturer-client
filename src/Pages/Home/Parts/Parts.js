...
const Parts = () => {
  return (
    <section className="cards">
      <article className="cardp card--1">
      ...
      <article className="cardp card--2">
        <div className="card__info-hover">
          <svg className="card__like" viewBox="0 0 24 24">
            <path
              fill="#000000"
      ...
      <article className="cardp card--3">
        <div className="card__info-hover">
          <svg className="card__like" viewBox="0 0 24 24">
            <path
              fill="#000000"
      ...
      <article className="cardp card--4">
        <div className="card__info-hover">
          <svg className="card__like" viewBox="0 0 24 24">
            <path
              fill="#000000"
      ...
      <article className="cardp card--5">
        <div className="card__info-hover">
          <svg className="card__like" viewBox="0 0 24 24">
            <path
              fill="#000000"
      ...
      <article className="cardp card--6">
        <div className="card__info-hover">
          <svg className="card__like" viewBox="0 0 24 24">
            <path
              fill="#000000"
